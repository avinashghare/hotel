...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2015 at 02:59 PM
...
CREATE TABLE IF NOT EXISTS `hotel_hotel` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `initialbalance` varchar(255) NOT NULL,
...
INSERT INTO `hotel_order` (`id`, `user`, `admin`, `hotel`, `days`, `userrate`, `hotelrate`, `status`, `price`) VALUES
(1, 4, 5, 1, '30 days', '22', '11', 1, '400');
...
INSERT INTO `hotel_transaction` (`id`, `user`, `hotel`, `amount`, `status`) VALUES
(1, 4, 1, '20000', 2);
