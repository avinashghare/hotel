    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel-body">
                <form class='form-horizontal tasi-form' method='post' action='<?php echo site_url("site/createorderreportbyadminsubmit");?>' enctype='multipart/form-data' target="_blank">
                    <div class="panel-body">
