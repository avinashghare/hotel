<div id="page-title">
    <a href="<?php echo site_url('site/viewmanagerbyadmin'); ?>" class="btn btn-primary btn-labeled fa fa-arrow-left margined pull-right">Back</a>
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
			  ...
			  <form class="form-horizontal tasi-form" method="post" action="<?php echo site_url('site/createmanagerbyadminsubmit');?>" enctype= "multipart/form-data">
