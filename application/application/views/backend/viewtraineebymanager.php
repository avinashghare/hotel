...
<!--       <a class="btn btn-primary btn-labeled fa fa-plus margined pull-right" href="<?php echo site_url('site/createuser'); ?>">Create</a>-->
    ...
    <h1 class="page-header text-overflow">Trainee Details</h1>
</div>
...
<!--                                    <th data-field="status">status</th>-->
		...
		<script>
            function drawtable(resultrow) {
                ...
                return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.name + "</td><td>" + resultrow.email + "</td><td>" + resultrow.accesslevelname + "</td><td><a class='btn btn-primary' href='<?php echo site_url('site/viewexecutiveoftraineebymanager?id='); ?>"+resultrow.id +"'>View</a></td><tr>";
            }
