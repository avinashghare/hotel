<div id="page-title">
    <a href="<?php echo site_url('site/viewexecutivebymanager?id=').$this->input->get('id'); ?>" class="btn btn-primary btn-labeled fa fa-arrow-left margined pull-right">Back</a>
        ...
        <div class="col-lg-12">
            <section class="panel">
               <div class="panel-heading">
							<h3 class="panel-title">Create Executive</h3>
						</div>
                <div class="panel-body">
			  <form class="form-horizontal tasi-form" method="post" action="<?php echo site_url('site/createexecutivebymanagersubmit');?>" enctype= "multipart/form-data">
				...
				<div class="form-group" style="display:none;">
				  ...
				  <div class="col-sm-4">
					<input type="text" id="normal-field" class="form-control" name="manager" value="<?php echo set_value('manager',$this->input->get('id'));?>">
				  </div>
				</div>
<!--
				<div class=" form-group">
...
-->
				...
				<div class=" form-group">
				  ...
				  <a href="<?php echo site_url('site/viewexecutivebymanager?id=').$this->input->get('id'); ?>" class="btn btn-secondary">Cancel</a>
				</div>
				</div>
			  </form>
			</div>
