<section class="panel">
    <header class="panel-heading">
        <h3 class="panel-title">Executive Details</h3>
    </header>
    <div class="panel-body">
			  <form class="form-horizontal tasi-form" method="post" action="<?php echo site_url('site/editexecutivebymanagersubmit');?>" enctype= "multipart/form-data">
				<input type="hidden" id="normal-field" class="form-control" name="id" value="<?php echo set_value('id',$before->id);?>" >
...
-->
				...
				<div class=" form-group">
				  ...
				  <a href="<?php echo site_url('site/viewexecutivebymanager?id=').$before->manager; ?>" class="btn btn-secondary">Cancel</a>
				</div>
				</div>
			  </form>
			</div>
