...
return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.admin + "</td><td>" + resultrow.user + "</td><td>" + resultrow.text + "</td><td><a class='btn btn-primary btn-xs' href='<?php echo site_url('site/editlog?id=');?>"+resultrow.id+"'><i class='icon-pencil'></i></a><a class='btn btn-danger btn-xs' href='<?php echo site_url('site/deletelog?id='); ?>"+resultrow.id+"'><i class='icon-trash '></i></a></td></tr>";
}
