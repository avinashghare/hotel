<div id="page-title">
       <a class="btn btn-primary btn-labeled fa fa-plus margined pull-right" href="<?php echo site_url('site/createexecutivebymanager?id=').$manager; ?>">Create</a>

    <h1 class="page-header text-overflow">Executives Details</h1>
</div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel drawchintantable">
                ...
                <?php $this->chintantable->createsearch("Executive List");?>
