...
$firstSplitArr = array("name"=>"splitID1", "value"=>"6", "merchantId"=>"5089108", "description"=>"test description", "commission"=>"2");
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table>
		...
		<tr>
		  ...
		  <td>TxnId: </td>
          <td><input name="txnid" id="txnid" value="<?php echo (empty($txnid)) ? '' : $txnid; ?>" /></td>
        </tr>
        <tr>
          <td>Amount: </td>
